  ...
  return (
    <div className="py-16 bg-gray-100 dark:bg-gray-950">
      <SectionHeading
        title_1="Get In"
        title_2="Touch"
        description="Do you have a project in mind or just want to say hi? I'd love to hear from you."
      />
                ...
                {contactInfo.map((item) => {
                  return (
                    <a
                      ...
                      key={item.label}
                      target="_blank"
                      className="flex items-center gap-4 p-4 bg-white dark:bg-gray-800 shadow-md rounded-xl hover:scale-102 transition-all duration-300 group"
                    >
                ...
                {socialLinks.map((link) => {
                  return (
                    <a
                      ...
                      key={link.label}
                      target="_blank"
                      className="w-12 h-12 rounded-xl bg-white shadow border dark:bg-gray-800 flex items-center justify-center text-muted-foreground hover:text-blue-500 transition-colors"
                    >
